...
import { JOIN_PREMIUM_FAILURE, JOIN_PREMIUM_SUCCESS } from "./premium"; // eslint-disable-line
...
export const FETCH_ACT_SIGNUP_FAILURE =
  'sharewis/user/FETCH_ACT_SIGNUP_FAILURE';
export const FETCH_ACT_SIGNUP_SUCCESS =
  'sharewis/user/FETCH_ACT_SIGNUP_SUCCESS';
...
export const START_ACT_FACEBOOK_LOGIN =
  'sharewis/user/START_ACT_FACEBOOK_LOGIN';
export const START_ACT_FACEBOOK_SIGNUP =
  'sharewis/user/START_ACT_FACEBOOK_SIGNUP';
export const START_FB_EMAIL_REQUEST = 'sharewis/user/START_FB_EMAIL_REQUEST';
export const CREATE_PURCHASED_GUEST_START =
  'sharewis/user/CREATE_PURCHASED_GUEST_START';
export const CREATE_PURCHASED_GUEST_SUCCESS =
  'sharewis/user/CREATE_PURCHASED_GUEST_SUCCESS';
export const CREATE_PURCHASED_GUEST_FAILURE =
  'sharewis/user/CREATE_PURCHASED_GUEST_FAILURE';
...
// Actions Creators
export const startActEmailLogin = createAction(
  START_ACT_EMAIL_LOGIN,
  ([email, password]) => ({ email, password })
);
export const startActFacebookLogin = createAction(
...
export const fetchActLoginSuccess = createAction(
  FETCH_ACT_LOGIN_SUCCESS,
  result => ({ ...result })
);
export const fetchFBEmailFailure = createAction(FETCH_FB_EMAIL_FAILURE);
export const fetchFBEmailSuccess = createAction(
  FETCH_FB_EMAIL_SUCCESS,
  ([email, facebookId]) => ({ email, facebookId })
);
export const startActEmailSignup = createAction(
  START_ACT_EMAIL_SIGNUP,
  ([email, password]) => ({ email, password })
);
export const startActFacebookSignup = createAction(
  START_ACT_FACEBOOK_SIGNUP,
  ([email, facebookId]) => ({ email, facebookId })
);
export const fetchActSignupFailure = createAction(FETCH_ACT_SIGNUP_FAILURE);
export const fetchActSignupSuccess = createAction(
  FETCH_ACT_SIGNUP_SUCCESS,
  result => ({ ...result })
);
export const finishOnboarding = createAction(FINISH_ONBOARDING);
export const createPurchasedGuestStart = createAction(
  CREATE_PURCHASED_GUEST_START
);
export const createPurchasedGuestSuccess = createAction(
  CREATE_PURCHASED_GUEST_SUCCESS
);
export const createPurchasedGuestFailure = createAction(
  CREATE_PURCHASED_GUEST_FAILURE
);
...
export const fetchUserBy = (loginMethod, credentials) => async dispatch => {
...
export const signupUserBy = (loginMethod, credentials) => async (
  dispatch,
  getState
) => {
  const { user } = getState();
 ...
 */
export const createPurchasedGuest = () => async dispatch => {
