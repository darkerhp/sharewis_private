...
import Signup from '../Signup'; // eslint-disable-line
  ...
  render() {
    return (
      <Swiper
        ...
        dot={
          <View
            style={[{ backgroundColor: 'rgba(0,0,0,.2)' }, styles.dotStyles]}
          />
        }
        activeDot={
          <View style={[{ backgroundColor: 'gray' }, styles.dotStyles]} />
        }
      ...
      >
        <Slide text={I18n.t('slide1Text')} imageSrc={slide1ImageSrc} />
        <Slide text={I18n.t('slide2Text')} imageSrc={slide2ImageSrc} />
        <Slide text={I18n.t('slide3Text')} imageSrc={slide3ImageSrc} />
        <Signup />
      </Swiper>
    );
  }
